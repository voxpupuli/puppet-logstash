...
describe "Logstash class:" do
  ...
  when 'RedHat'
    ...
    url          = 'https://download.elasticsearch.org/logstash/logstash/packages/centos/logstash-1.4.1-1_bd507eb.noarch.rpm'
  ...
  when 'Debian'
    package_name = 'logstash'
    service_name = 'logstash'
    url          = 'https://download.elasticsearch.org/logstash/logstash/packages/debian/logstash_1.4.1-1-bd507eb_all.deb'

...
#  http://logstash.net/docs/1.2.2/filters/json
#
...
define logstash::filter::json (
  ...
  file { $conffiles:
    ...
    content => "filter {\n${opt_cond_start} json {\n${opt_add_field}${opt_add_tag}${opt_exclude_tags}${opt_remove_tag}${opt_source}${opt_tags}${opt_target}${opt_type}${opt_cond_end}}\n}\n",
    mode    => '0440',

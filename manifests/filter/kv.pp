...
#  http://logstash.net/docs/1.2.2/filters/kv
#
...
define logstash::filter::kv (
  ...
  if ($field_split != '') {
    ...
    $opt_field_split = "${opt_indent}field_split => \"${field_split}\"\n"
  }
  ...
  if ($value_split != '') {
    ...
    $opt_value_split = "${opt_indent}value_split => \"${value_split}\"\n"
  }

  if ($prefix != '') {
    validate_string($prefix)
    $opt_prefix = "${opt_indent}prefix => \"${prefix}\"\n"
  }
  ...
  file { $conffiles:
    ...
    content => "filter {\n${opt_cond_start} kv {\n${opt_add_field}${opt_add_tag}${opt_exclude_tags}${opt_field_split}${opt_fields}${opt_prefix}${opt_remove_tag}${opt_source}${opt_tags}${opt_target}${opt_trim}${opt_type}${opt_value_split}${opt_cond_end}}\n}\n",
    mode    => '0440',

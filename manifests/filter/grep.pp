...
#  http://logstash.net/docs/1.2.2/filters/grep
#
...
define logstash::filter::grep (
  ...
  file { $conffiles:
    ...
    content => "filter {\n${opt_cond_start} grep {\n${opt_add_field}${opt_add_tag}${opt_drop}${opt_exclude_tags}${opt_match}${opt_negate}${opt_remove_tag}${opt_tags}${opt_type}${opt_cond_end}}\n}\n",
    mode    => '0440',

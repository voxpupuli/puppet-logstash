...
#  http://logstash.net/docs/1.2.2/filters/environment
#
...
define logstash::filter::environment (
  ...
  if ($add_field_from_env != '') {
    ...
    $opt_add_field_from_env = "${opt_indent}add_field_from_env => ${arr_add_field_from_env}\n"
  }
  ...
  file { $conffiles:
    ...
    content => "filter {\n${opt_cond_start} environment {\n${opt_add_field}${opt_add_field_from_env}${opt_add_tag}${opt_exclude_tags}${opt_remove_tag}${opt_tags}${opt_type}${opt_cond_end}}\n}\n",
    mode    => '0440',

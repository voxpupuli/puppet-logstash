...
#  http://logstash.net/docs/1.1.12/inputs/lumberjack2
#
...
define logstash::input::lumberjack2 (
  ...
  if ($their_public_key != '') {
    if $their_public_key =~ /^puppet\:\/\// {
      ...
      $opt_their_public_key = "  their_public_key => \"${filesdir}/${basefilename_their_public_key}\"\n"
  ...
  if ($my_secret_key != '') {
    if $my_secret_key =~ /^puppet\:\/\// {
      ...
      $opt_my_secret_key = "  my_secret_key => \"${filesdir}/${basefilename_my_secret_key}\"\n"

...
#
# [*app*]
#   The name of your heroku application. This is usually the first part of
#   the the domain name 'my-app-name.herokuapp.com'
...
#  http://logstash.net/docs/1.2.2/inputs/heroku
#
...
define logstash::input::heroku (
  ...
  file { $conffiles:
    ...
    content => "input {\n${opt_cond_start} heroku {\n${opt_add_field}${opt_app}${opt_debug}${opt_codec}${opt_tags}${opt_type}${opt_cond_end}}\n}\n",
    mode    => '0440',

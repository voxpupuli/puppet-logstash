...
#  http://logstash.net/docs/1.2.2/inputs/elasticsearch
#
...
define logstash::input::elasticsearch (
  ...
  file { $conffiles:
    ...
    content => "input {\n${opt_cond_start} elasticsearch {\n${opt_add_field}${opt_debug}${opt_host}${opt_index}${opt_codec}${opt_port}${opt_query}${opt_tags}${opt_type}${opt_cond_end}}\n}\n",
    mode    => '0440',

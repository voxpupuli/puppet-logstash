...
#  http://logstash.net/docs/1.1.12/inputs/snmptrap
#
...
define logstash::input::snmptrap (
  ...
  file { $conffiles:
    ...
    content => "input {\n snmptrap {\n${opt_add_field}${opt_charset}${opt_community}${opt_debug}${opt_format}${opt_host}${opt_message_format}${opt_port}${opt_tags}${opt_type} }\n}\n",
    mode    => '0440',

...
#  http://logstash.net/docs/1.2.2/inputs/eventlog
#
...
define logstash::input::eventlog (
  ...
  if ($logfile != '') {
    ...
    $opt_logfile = "${opt_indent}logfile => \"${logfile}\"\n"
  }
  ...
  file { $conffiles:
    ...
    content => "input {\n${opt_cond_start} eventlog {\n${opt_add_field}${opt_debug}${opt_logfile}${opt_codec}${opt_tags}${opt_type}${opt_cond_end}}\n}\n",
    mode    => '0440',

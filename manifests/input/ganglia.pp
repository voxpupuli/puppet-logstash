...
#  http://logstash.net/docs/1.1.12/inputs/ganglia
#
...
define logstash::input::ganglia (
  ...
  if $logstash::multi_instance == true {
    ...
    $conffiles    = suffix($confdirstart, "/config/input_ganglia_${name}")
  ...
  file { $conffiles:
    ...
    content => "input {\n ganglia {\n${opt_add_field}${opt_charset}${opt_debug}${opt_format}${opt_host}${opt_message_format}${opt_port}${opt_tags}${opt_type} }\n}\n",
    mode    => '0440',
